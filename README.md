...
```sh
make docker-build docker-push IMG=<some-registry>/managed-cluster:tag
```
...
```sh
make deploy IMG=<some-registry>/managed-cluster:tag
```
...
```sh
make build-installer IMG=<some-registry>/managed-cluster:tag
```
